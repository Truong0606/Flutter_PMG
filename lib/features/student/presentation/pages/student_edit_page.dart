...
class _StudentEditPageState extends State<StudentEditPage> {
  ...
  void didChangeDependencies() {
    ...
    _student = (args is Student)
        ? args
        : const Student(id: 0, name: '', gender: '', dateOfBirth: '');
    _nameCtrl.text = _student.name;
    _gender = _student.gender.isNotEmpty ? _student.gender : null;
    _dobCtrl.text = _student.dateOfBirth;
    _placeCtrl.text = _student.placeOfBirth ?? '';
    _profileUrl = _student.profileImage;
    _householdUrl = _student.householdRegistrationImg;
    _birthCertUrl = _student.birthCertificateImg;
  }

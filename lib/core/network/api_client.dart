...
class ApiClient {
  ...
  Future<Map<String, String>> _getHeaders() async {
    ...
    if (kDebugMode) {
      ...
      debugPrint('[ApiClient] Headers: auth=${headers.containsKey('Authorization')}');
    }
  ...
  Future<http.Response> postParent(String endpoint, {Map<String, dynamic>? body}) async {
    final url = Uri.parse('$parentBaseUrl$endpoint');
    final headers = await _getHeaders();
    try {
  ...
  Future<http.Response> putParent(String endpoint, {Map<String, dynamic>? body}) async {
    final url = Uri.parse('$parentBaseUrl$endpoint');
    final headers = await _getHeaders();
    if (kDebugMode) {
  ...
  Future<http.Response> postClass(String endpoint, {Map<String, dynamic>? body}) async {
    final url = Uri.parse('$classBaseUrl$endpoint');
    final headers = await _getHeaders();
    if (kDebugMode) {
  ...
  Future<http.Response> putClass(String endpoint, {Map<String, dynamic>? body}) async {
    final url = Uri.parse('$classBaseUrl$endpoint');
    final headers = await _getHeaders();
    if (kDebugMode) {
